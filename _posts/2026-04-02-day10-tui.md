...
Following my earlier [post]({% post_url 2026-04-02-opam-overlay-ci %}), it occurred to me that I had already written a TUI tool for viewing `day10` logs, but the scripts that generated the build information were stopped ages ago. Now with build artefacts in GitHub in virtually the same format, I have refreshed the project to display and diff these logs instead.
