...
The upgrade went without issue following the notes from last [time]({% post_url 2025-03-26-freebsd-14.2 %}). [ocurrent/freebsd-infra](https://github.com/ocurrent/freebsd-infra) was updated with [PR#18](https://github.com/ocurrent/freebsd-infra/pull/18) and the base images were recreated with `ansible-playbook update.yml`.
