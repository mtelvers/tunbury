...
In a previous [post]({% post_url 2026-02-15-ocaml-tessera %}), I compared the [ONNX Runtime](https://github.com/mtelvers/onnxruntume) with PyTorch on the CPU and GPU. In this post, I take this to the extreme to see if a CPU can outpace the NVIDIA L4 GPU.
...
The [model]({% post_url 2026-02-25-teserra-pipeline %}) produces 128-dimensional embeddings from multi-temporal Sentinel-2 and Sentinel-1 satellite imagery. Each inference takes two inputs:
