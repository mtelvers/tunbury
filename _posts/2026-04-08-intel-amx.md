...
In this post, I am going to compare our monster [AMD EPYC with NVIDIA L4]({% post_url 2026-03-11-gpu-vs-cpu %}) with two commonly available machines on Azure, which have nearly identical hourly rates:
...
Previously, I found that [ONNX outperformed PyTorch]({% post_url 2026-02-15-ocaml-tessera %}) by 14% on both GPU and CPU; however, on AMX hardware, that reverses completely.
