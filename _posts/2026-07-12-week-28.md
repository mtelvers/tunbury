...
The [Source Cooperative upload]({% post_url 2026-07-05-week-27 %}) is now an unattended background job rather than the manual grind it was last week, thanks to two changes.
