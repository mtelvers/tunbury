...
I have written about [dm-cache]({% post_url 2025-04-21-ubuntu-dm-cache %}) previously, when I used it with LVM for SSD/HDD caching. In this post, I will explore using dm-cache with RAM as the cache layer over a spinning disk.
