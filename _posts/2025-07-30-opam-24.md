...
The OS reinstallation is documented in this [post]({% post_url 2025-05-06-freebsd-uefi %}), and it's definitely worth reading the [README.md](https://github.com/ocurrent/freebsd-infra/blob/master/README.md) in the repo for the post-installation steps.
